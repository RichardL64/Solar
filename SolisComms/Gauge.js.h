/*
    ...
    SVG Gauge drawing JS
    Modified from Naikus original
...
(function(global, factory) {
  ...
  var Gauge = (function() {
    ...
    /**
     * Translates percentage value to angle. e.g. 
     * If gauge span angle is 180deg, then 50% will be 90deg
     */
